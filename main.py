...
def main():
    ...
    print(make_table(' SuperJob Moscow ', get_statistics(parse_superjob_vacancies, languages, superjob_secret_key)))
    print()
    print(make_table(' HeadHunter Moscow ', get_statistics(parse_hh_vacancies, languages)))
    print()
